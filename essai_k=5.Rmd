...
Dans notre cas, la méthode des kmeans permet une convergence plus rapide, cependant, la CAH, nous permet d'obtenir un groupe de pays plus restreint. Puisque notre budget est limité, cette méthode semble plus adaptée à notre situation. \
